 ...
 *
 */
RfxCom.prototype.tempbaroHandler = function(data) {
	 var self = this,
	  fore_cast = {
		0:	"No Forecast",
		1:	"Sunny",
        ...
        signbit = data[4] & 0x80,
        humidity = data[6],
        humidityStatus = hum_stat[data[7]],
        barometer = ((data[8] & 0x7f) * 256 + data[9]),
		forecast = fore_cast[data[10]],
		batterySignalLevel = data[8] & 0xff + (data[9]>>8) & 0xff,
        evt = {
            subtype: subtype,
            id: id,
            seqnbr: seqnbr,
    ...
    self.emit("tempbaro" + subtype, evt);
};
...
RfxCom.prototype.tempbaro12Handler = function(data) {
     var self = this,
        ...
        humidityStatus = data[7],
        barometer = ((data[8] & 0x7f) * 256 + data[9]),
        // forecast = forecast[data[10]],
        batterySignalLevel = data[11] & 0xff + (data[9]>>8) & 0xff,
        evt = {
            subtype: subtype,
            id: id,
            seqnbr: seqnbr,
