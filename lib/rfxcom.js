...
class RfxCom extends EventEmitter {
    ...
    enableRFXProtocols(protocols, callback) {
        ...
        return self._sendMessage(0, 0, 0x03, msg, callback);
    };
...
//------------------------------------------
    ...
    statusMessageHandler(data) {
        const
            ...
            seqnbr = data[1],
            cmnd = data[2];
        let msg, receiverType, hardwareVersion, firmwareVersion, firmwareType, protocols, copyrightText;
 ...
 */
    weightHandler(data) {
        ...
        this.emit("weight" + evt.subtype, evt);
    };
