...
class RfxCom extends EventEmitter {
    constructor(device, options) {
        ...
        self.deviceNames = rfxcom.deviceNames;
 ...
 */
    thermostat1Handler(data, type) {
        ...
        this.emit("thermostat1", evt, type);
    };
 ...
 */
    thermostat3Handler(data, type) {
        ...
        this.emit("thermostat3", evt, type);
    };
 ...
 */
    temprainHandler(data, type) {
        ...
        this.emit("temperaturerain1", evt, type);
    };
 ...
 */
    tempHandler(data, type) {
        ...
        this.emit("temperature1", evt, type);
    };
 ...
 */
    temphumidityHandler(data, type) {
        ...
        this.emit("temperaturehumidity1", evt, type);
    };
 ...
 */
    temphumbaroHandler(data, type) {
        ...
        this.emit("temphumbaro1", evt, type);
    };
 ...
 *
 */
    cartelectronicHandler(data, type) {
        const
            subtype = data[0],
            seqnbr = data[1],
            evt = {
        ...
        this.emit("cartelectronic", evt, type);
    };
