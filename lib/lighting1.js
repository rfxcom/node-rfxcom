...
Lighting1.prototype._splitDeviceId = function(deviceId) {
        ...
        unit = parseInt(parts[1]);
        if (houseCode < 0x41 || (this.subtype == 0x02 && houseCode > 0x43) ||
            ((this.subtype == 0x06 || this.subtype == 0x0a) && houseCode > 0x44) || houseCode > 0x50) {
            throw new Error("Invalid house code")
        }
        if  (((this.subtype == 0 || this.subtype == 1 || this.subtype == 3) && unit > 16) ||
             ((this.subtype == 2  || this.subtype == 5) && unit > 64) ||
              (this.subtype == 7 && unit > 8) ||
              (this.subtype == 9 && unit > 10) ||
             ((this.subtype == 4 || this.subtype == 6 || this.subtype == 8 || this.subtype == 11) && unit > 4)) {
...
Lighting1.prototype._sendCommand = function (deviceId, command, callback) {
        ...
        if (device.unitCode === 0) {
            command = command + 5;
            if (self.subtype != 0x00 && self.subtype != 0x01 && self.subtype != 0x07 &&
                self.subtype != 0x08 && self.subtype != 0x09) {
 ...
 */
Lighting1.prototype.inreaseLevel = function (deviceId, callback) {
