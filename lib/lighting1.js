...
Lighting1.prototype._splitDeviceId = function(deviceId) {
        ...
        if (houseCode < 0x41 || (this.subtype === 0x04 && houseCode > 0x43) ||
            ((this.subtype === 0x06 || this.subtype === 0x0a) && houseCode > 0x44) || houseCode > 0x50) {
            throw new Error("Invalid house code '" + parts[0] + "'");
        }
        if  (((this.subtype === 0 || this.subtype === 1 || this.subtype === 3) && unitCode > 16) ||
             ((this.subtype === 2  || this.subtype === 5) && unitCode > 64) ||
              (this.subtype === 7 && unitCode > 8) ||
              (this.subtype === 9 && unitCode > 10) ||
             ((this.subtype === 4 || this.subtype === 6 || this.subtype === 8 || this.subtype === 10) && unitCode > 4)) {
