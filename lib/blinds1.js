...
Blinds1.prototype._splitDeviceId = function(deviceId) {
    ...
    // 0 is always a valid unitCode (maybe group)
    if (unitCode > 15 || (this.isSubtype("BLINDS_T9") && unitCode > 6) || (this.isSubtype("BLINDS_T8") && unitCode > 5)) {
        throw new Error("Invalid unit code " + parts[1]);
    }
    if ((id.value === 0) ||
         (this.isSubtype("BLINDS_T8") && id.value > 0xfff) ||
        ((this.isSubtype("BLINDS_T0") || this.isSubtype("BLINDS_T1") || this.isSubtype("BLINDS_T12")) && id.value > 0xffff) ||
        ((this.isSubtype("BLINDS_T2") || this.isSubtype("BLINDS_T3") || this.isSubtype("BLINDS_T4") ||
         (this.isSubtype("BLINDS_T9") && id.value > 0xfffff) ||
          this.isSubtype("BLINDS_T5") || this.isSubtype("BLINDS_T10") || this.isSubtype("BLINDS_T11")) && id.value > 0xffffff) ||
...
Blinds1.prototype.set = function(deviceId, callback) {
    if (this.isSubtype("BLINDS_T0") || this.isSubtype("BLINDS_T1") ||
        ...
        throw new Error("Device does not support set()");
    }
};
