...
Curtain1.prototype.open = function(deviceId, callback) {
  return this._sendCommand(deviceId, defines.CURTAIN_OPEN);
};
...
Curtain1.prototype.close = function(deviceId, callback) {
  return this._sendCommand(deviceId, defines.CURTAIN_CLOSE);
};
...
Curtain1.prototype.stop = function(deviceId, callback) {
  return this._sendCommand(deviceId, defines.CURTAIN_STOP);
};
...
Curtain1.prototype.program = function(deviceId, callback) {
  return this._sendCommand(deviceId, defines.CURTAIN_PROGRAM);
};
