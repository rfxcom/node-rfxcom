 ...
 */
    sendMessage(deviceId, params, callback) {
        ...
        } else if (params.repeats === undefined) {
            throw new Error("Missing params.repeats");
        } else if (params.repeats < 1 || params.repeats > 10) {
            throw new Error("Invalid number of repeats: " + params.repeats);
        } else if (params.pulseTimes === undefined) {
            throw new Error("Missing params.pulseTimes");
        }
        let pulseTimes;
        ...
        if (pulseTimes.length > 496) {
            throw new Error("Too many pulse times, maximum 496");
        }
