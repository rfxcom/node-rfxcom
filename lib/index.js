...
exports.transmitterPacketTypes = ["asyncconfig", "asyncdata", "blinds1", "camera1", "chime1", "curtain1", "fan", "funkbus",
    "homeConfort", "lighting1", "lighting2", "lighting3", "lighting4", "lighting5", "lighting6", "radiator1", "remote",
    "rfy", "security1", "thermostat1", "thermostat2", "thermostat3", "thermostat4"];
...
exports.fan = reflect(['SIEMENS_SF01', 'ITHO_CVE_RFT', 'LUCCI_AIR', 'SEAV_TXS4', 'WESTINGHOUSE_7226640',
                       'LUCCI_AIR_DC', 'CASAFAN', 'FT121_1R', 'FALMEC', 'LUCCI_AIR_DCII']);
...
// Packet type 0x42
exports.thermostat3 = reflect(['G6R_H4T1', 'G6R_H4TB', 'G6R_H4TD', 'G6R_H4S', 'G6R-H3T1']);
...
exports.deviceNames = {
    ...
    0x14: [["LightwaveRF", "Siemens"], ["EMW100", "GAO", "Everflourish"], ["BBSB new types"], ["MDREMOTE 106 LED Dimmer"],
           ...
           ["Kangtai", "Cotech"]],
    0x15: [["Blyss"], ["Cuveo"]],
    0x16: [["Byron SX"], ["Byron MP001"], ["SelectPlus"], ["RFU"], ["Envivo"]],
    0x19: [["Bofu", "RollerTrol", "Hasta (new)", "Louvolite"], ["Hasta (old)"], ["A-OK RF01"], ["A-OK AC114", "A-OK AC123", "Motorlux"],
           ...
           ["Confexx CNF24-2435"], ["Screenline"], ["Hualite"], ["Motivia"], ["Zemismart"]],
    0x20: [["X10 security door sensor", "X10 security window sensor"], ["X10 security motion sensor"], ["X10 security remote"],
           ...
           ["Visonic CodeSecure"], ["Visonic PowerCode auxiliary contact"], ["Meiantech"], ["SA30", "SA33"], ["RM174RF"]],
