...
// Device names (only required for packet types that can be received)
...
// Remote control command translation tables
const
    // Packet types that can be received and contain encoded commands
    LIGHTING1 = 0x10,
    LIGHTING2 = 0x11,
    LIGHTING5 = 0x14,
    LIGHTING6 = 0x15,
...
commands[REMOTE][0x00] = { // ATI_REMOTE_WONDER
        0:   "A",
        1:   "B",
        2:   "power",
        3:   "TV",
...
commands[REMOTE][0x01] = { // ATI_REMOTE_WONDER_PLUS
        0:   "A",
        1:   "B",
        2:   "power",
        3:   "TV",
...
commands[REMOTE][0x03] = { // X10_PC_REMOTE
        2:   "0",
        18:  "8",
        34:  "4",
        56:  "Rewind",
...
commands[REMOTE][0x04] = { // ATI_REMOTE_WONDER_2
        0:   "A",
        1:   "B",
        2:   "power",
        3:   "TV",
...
commands[BLINDS2][0x00] = {0: "Up", 1: "Down", 4: "Stop", 5: "Pair", 6: "Set Percent", 7: "Set Angle", 8: "Set Percent and Angle"};
