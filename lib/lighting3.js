 ...
 */
Lighting3.prototype.isSubtype = function (subtypeName) {
    return index.lighting3[subtypeName] === this.subtype;
};
...
Lighting3.prototype._timeoutHandler = function(buffer, seqnbr) {
    return false;
};
...
Lighting3.prototype._sendCommand = function (deviceId, command, callback) {
    ...
    var buffer = [0x08, defines.LIGHTING3, self.subtype, seqnbr,
