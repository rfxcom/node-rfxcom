...
Lighting5.prototype._splitDeviceId = function(deviceId) {
    ...
    if (this.isSubtype("MDREMOTE") || this.isSubtype("LIVOLO") || this.isSubtype("TRC02") || this.isSubtype("AOKE")) {
        unitCode = 1;
        if (parts.length !== 1) {
    ...
    if (id.value < 1 || ((this.isSubtype("LIGHTWAVERF") || this.isSubtype("CONRAD") || this.isSubtype("TRC02")) && id.value > 0xffffff) ||
        ...
        ((this.isSubtype("MDREMOTE") || this.isSubtype("AOKE") || this.isSubtype("LIVOLO")) && id.value > 0xffff)) {
