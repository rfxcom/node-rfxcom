...
describe('Blinds1 class', function () {
    ...
    describe('.BLINDS_T0', function () {
        ...
        it('should log the bytes being sent in debug mode', function (done) {
            ...
            expect(consoleSpy).toHaveBeenCalledWith('[rfxcom] on /dev/ttyUSB0 - Sent    : %s', ['09', '19', '00', '00', '00', '12', '34', '05', '00', '00']);
    ...
    describe('.BLINDS_T2', function () {
        ...
        it('should throw an error for set() command', function () {
            ...
            }).toThrow(new Error("Device does not support set()"));
        });
        it('should throw an error for down() command', function () {
            expect(function () {
                blinds1.down('0x1234/5')
    ...
    describe('.BLINDS_T9', function () {
        ...
        it('should send the correct bytes for a set() command to the serialport', function (done) {
            var sentCommandId;
            blinds1.set('0x12345/5', function (err, response, cmdId) {
                sentCommandId = cmdId;
                done();
            });
